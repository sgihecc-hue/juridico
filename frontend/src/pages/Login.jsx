      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[540px] flex-col justify-between p-10" style={{ backgroundColor: '#1e293b' }}>
        <div>
          ...
          <h2 className="text-3xl font-bold text-white leading-tight mb-4">
            Gerencie seu escritorio com eficiencia
          </h2>
          <p className="text-slate-400 text-sm leading-relaxed max-w-sm">
            Controle processos, prazos, financeiro, documentos e equipe em uma unica plataforma integrada.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 text-slate-400 text-sm">
            <svg className="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
            Controle financeiro com honorarios e despesas
          </div>
          <div className="flex items-center gap-3 text-slate-400 text-sm">
            <svg className="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
            Agenda integrada com prazos e audiencias
          </div>
          <div className="flex items-center gap-3 text-slate-400 text-sm">
            <svg className="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
            Geracao de pecas com modelos personalizados
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-[380px]">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <h1 className="text-xl font-bold text-gray-900">Juridico</h1>
            <p className="text-sm text-gray-500">Escritorio Digital</p>
          </div>

          <div className="hidden lg:block mb-8">
            <h1 className="text-xl font-bold text-gray-900 mb-1">Entrar na sua conta</h1>
            <p className="text-sm text-gray-500">Preencha seus dados para acessar o sistema</p>
          </div>
